import { S as SvelteComponent, i as init, a as safe_not_equal, b as append_styles, e as element, d as attr, f as insert, n as noop, h as detach, j as space, k as set_custom_element_data, l as append, u as update_slot_base, m as get_all_dirty_from_scope, p as get_slot_changes, t as transition_in, q as transition_out, r as set_style, v as add_render_callback, w as add_resize_listener, x as listen, y as group_outros, z as update_keyed_each, A as check_outros, o as onMount, B as create_slot, C as text, D as outro_and_destroy_block, E as tick, F as binding_callbacks, G as create_component, H as mount_component, I as destroy_component, J as empty, K as set_data, L as destroy_each, c as createEventDispatcher, M as onDestroy, N as beforeUpdate, O as run_all, P as svg_element, Q as get_spread_update, R as get_spread_object, T as prevent_default, U as toggle_class, V as assign, W as set_attributes, X as set_input_value, Y as HtmlTag } from './common/index-a93268da.js';

/* node_modules/svelte-select/src/Item.svelte generated by Svelte v3.46.4 */

function add_css(target) {
	append_styles(target, "svelte-bdnybl", ".item.svelte-bdnybl{cursor:default;height:var(--height, 42px);line-height:var(--height, 42px);padding:var(--itemPadding, 0 20px);color:var(--itemColor, inherit);text-overflow:ellipsis;overflow:hidden;white-space:nowrap}.groupHeader.svelte-bdnybl{text-transform:var(--groupTitleTextTransform, uppercase)}.groupItem.svelte-bdnybl{padding-left:var(--groupItemPaddingLeft, 40px)}.item.svelte-bdnybl:active{background:var(--itemActiveBackground, #b9daff)}.item.active.svelte-bdnybl{background:var(--itemIsActiveBG, #007aff);color:var(--itemIsActiveColor, #fff)}.item.first.svelte-bdnybl{border-radius:var(--itemFirstBorderRadius, 4px 4px 0 0)}.item.hover.svelte-bdnybl:not(.active){background:var(--itemHoverBG, #e7f2ff)}");
}
...
function add_css$1(target) {
	append_styles(target, "svelte-p6ehlv", "svelte-virtual-list-viewport.svelte-p6ehlv{position:relative;overflow-y:auto;-webkit-overflow-scrolling:touch;display:block}svelte-virtual-list-contents.svelte-p6ehlv,svelte-virtual-list-row.svelte-p6ehlv{display:block}svelte-virtual-list-row.svelte-p6ehlv{overflow:hidden}");
}
...
function add_css$3(target) {
	append_styles(target, "svelte-ch6bh7", ".selection.svelte-ch6bh7{text-overflow:ellipsis;overflow-x:hidden;white-space:nowrap}");
}
...
class Selection extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { getSelectionLabel: 0, item: 1 }, add_css$3);
	}
}
...
function create_fragment$6(ctx) {
	...
	let if_block4 = /*showSelectedItem*/ ctx[28] && /*isClearable*/ ctx[16] && !/*isDisabled*/ ctx[10] && !/*isWaiting*/ ctx[5] && create_if_block_3$1(ctx);
	...
	let if_block6 = /*isWaiting*/ ctx[5] && create_if_block$2();
