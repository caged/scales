...
<div
  class="flex bg-gray-50 *:p-5 *:border-r *:border-gray-200 border-b border-gray-300 dark:bg-gray-800 dark:*:border-gray-700 dark:border-gray-700">
  <div>
...
{#if triads.length > 0}
  <div class="relative bg-gray-50 border-t border-gray-200 p-5 dark:bg-gray-800 dark:border-gray-700">
